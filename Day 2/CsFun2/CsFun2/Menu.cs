...
public class Menu
{
    public void DisplayMenu()
    {
        ...
        {
            new("Nguyen Van", "Nam", "Nam", new DateTime(1999, 06, 02), "0945628812", "VietNam", true),
            new("Do Tuan", "Duc", "Nam", new DateTime(2000, 11, 08), "0938428762", "VietNam", false),
            new("Hoang Thanh", "Huong", "Nu", new DateTime(2002, 4, 20), "0948348712", "VietNam", false)
        };
